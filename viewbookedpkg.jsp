    ...
    <% 
       ...
       if(request.getParameter("btnSubmit")!=null){
            try {
                ...
                PreparedStatement ps = con.prepareStatement("SELECT id, idnum, phn, email, location, airport, month, adultsno, childno, bookingid, package, date FROM booking WHERE idnum=?");
               // ps.setString(1, id);
