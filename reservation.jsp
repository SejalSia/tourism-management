...
<h2> Reservation Form</h2>
    ...
    <label class="required">ID</label>
        ...
        <select name="drpdate" required>
            <option value="01 to 7">From 1st to 7th of selected month</option>
            <option value="14 to 20">From 14th to 20th of selected month</option>
            <option value="23 to 30">From 23rd to 30th of selected month</option>
        </select><br>
