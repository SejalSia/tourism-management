    ...
    <div class="content">
      <div class="sidebar">
        <div class="button-group">
          ...
          <button class="button" onclick="window.location.href='addhotel.jsp'">Hotels</button>
          <button class="button" onclick="window.location.href='modifydestination.jsp'">Destinations</button>
          ...
          <button class="button" onclick="window.location.href='about.jsp'">About Section</button>
        </div>
      </div>
      <div class="main-content">
        <div class="top-panel">
          ...
          <button onclick="window.location.href='Dashboard.jsp'">Logout</button>
        </div>
