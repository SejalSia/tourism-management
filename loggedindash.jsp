...
<div class="container"> 
    <div class="left-panel">
        ...
        <button class="button" onclick="window.location.href='viewPackage.jsp'">Check Package</button>
        <button class="button" onclick="window.location.href='reservation.jsp'">Book Package</button>
        <button class="button" onclick="window.location.href='viewbookedpkg.jsp'">View Package</button>
    ...
    <div class="right-panel">
        <div class="navbar">
            ...
            <button class="button" onclick="window.location.href='destination.jsp'">Destinations</button>
            <button class="button">Offers</button>
            <div class="dropdown">
                <button class="button" id="optionBtn">Login/SignUp</button>
                <div class="dropdown-content">
                    <button id="logoutBtn" onclick="window.location.href='Dashboard.jsp'">Logout</button>
        ...
        <div class="moving-text-container">
            <span class="moving-text">45% off on Packages</span>
        </div>
