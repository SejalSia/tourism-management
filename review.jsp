...
<body>
    <div class="container">
        <h2>Gold Package Review</h2>
        <form>
            <label for="username">Username</label>
            <input type="text" id="username" name="txtUNAME" required><br>
            <label for="DESTINATIONS">Destinations</label>
            <select id="DESTINATIONS" name="drpDESTINATION" required>
            ...
            <select id="PACKAGE" name="drpPACKAGE" required>
            ...
            <input type="text" id="feedback" name="txtREVIEW"><br>
